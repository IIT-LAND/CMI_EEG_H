...
```{r, warning=FALSE, message=FALSE}
# load
rseo_umap_data = read.csv(file.path(tidypath,"tidy_H_revalsubgroups_rsopen_umap+cl.csv"))
rsec_umap_data = read.csv(file.path(tidypath,"tidy_H_revalsubgroups_rsclosed_umap+cl.csv"))
```
...
p = ggplot(data=data2use, aes(x=umap1,y=umap2)) +
  ...
  ylim(0.5, 10.5) 
p
ggsave(filename = file.path(rsopen_plot_path, "sigclust","03_UMAP_training.pdf"))
...
p = ggplot(data=data2use, aes(x=umap1,y=umap2)) +
  ...
  ylim(0.5, 10.5)
p
ggsave(filename = file.path(rsopen_plot_path,"sigclust","03_UMAP_validation.pdf"))
...
p = ggplot(data=data2use, aes(x=umap1,y=umap2)) +
  ...
  ylim(-4.5,6.5)
p
ggsave(filename = file.path(rsclosed_plot_path,"sigclust","03_UMAP_training.pdf"))
...
p = ggplot(data=data2use, aes(x=umap1,y=umap2)) +
  ...
  ylim(-4.5,6.5)
p
ggsave(filename = file.path(rsclosed_plot_path,"sigclust","03_UMAP_validation.pdf"))
...
# save
write.csv(sigclust_results, file = file.path(resultpath,"03_sigclust10000x_results.csv"))
