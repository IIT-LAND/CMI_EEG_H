...
rseo_data = read.csv(file.path(tidypath,"tidy_H_rsopen_PCA.csv"))
rsec_data = read.csv(file.path(tidypath,"tidy_H_rsclosed_PCA.csv"))
```
...
for (pc in principal_components){
  ...
  # scale data
  vars2scale = c("Score","age","num_bad_channels", "pct_bad_samples")
  ...
  form2use = as.formula("Score ~ subtype*age + num_bad_channels + pct_bad_samples + (1|study_site) + (block|subid)")
  ...
  rsopen_output_res[pc,"td_vs_a1_t"] = lme_res$coefficients["subtypea1","t value"] 
  rsopen_output_res[pc,"td_vs_a1_p"] = lme_res$coefficients["subtypea1","Pr(>|t|)"] 
  
  rsopen_output_res[pc,"td_vs_a2_t"] = lme_res$coefficients["subtypea2","t value"] 
  rsopen_output_res[pc,"td_vs_a2_p"] = lme_res$coefficients["subtypea2","Pr(>|t|)"]
  ...
  ggsave(filename = file.path(rsopen_plotpath,"pca",sprintf("07_PCAscores_%s.pdf", pc)))
  ...
  ggsave(filename = file.path(rsopen_plotpath,"H",sprintf("07_PCAscores_%s_blockscollapsed.pdf", pc)))
  ...
  ggsave(filename = file.path(rsopen_plotpath,"pca",sprintf("07_PCAscores_%s_age_groupscollapsed.pdf", pc))) 
  ...
  ggsave(filename = file.path(rsopen_plotpath,"pca",sprintf("07_PCAscores_%s_age.pdf", pc))) 
  ...
  ggsave(filename = file.path(rsopen_plotpath,"pca",sprintf("07_PCAscores_%s_age_blockscollapsed.pdf", pc))) 
  ...
  rsclosed_output_res[pc,"td_vs_a1_t"] = lme_res$coefficients["subtypea1","t value"] 
  rsclosed_output_res[pc,"td_vs_a1_p"] = lme_res$coefficients["subtypea1","Pr(>|t|)"] 
  
  rsclosed_output_res[pc,"td_vs_a2_t"] = lme_res$coefficients["subtypea2","t value"] 
  rsclosed_output_res[pc,"td_vs_a2_p"] = lme_res$coefficients["subtypea2","Pr(>|t|)"]
  ...
  ggsave(filename = file.path(rsclosed_plotpath,"pca",sprintf("07_PCAscores_%s.pdf", pc)))
  ...
  ggsave(filename = file.path(rsclosed_plotpath,"H",sprintf("07_PCAscores_%s_blockscollapsed.pdf", pc)))
  ...
  ggsave(filename = file.path(rsclosed_plotpath,"pca",sprintf("07_PCAscores_%s_age_groupscollapsed.pdf", pc))) 
  ...
  ggsave(filename = file.path(rsclosed_plotpath,"pca",sprintf("07_PCAscores_%s_age.pdf", pc))) 
  ...
  ggsave(filename = file.path(rsclosed_plotpath,"pca",sprintf("07_PCAscores_%s_age_blockscollapsed.pdf", pc))) 
...
write.csv(rsopen_output_res, file = file.path(resultpath,"07_rsopen_PCA_subtype*age.csv"))
write.csv(rsclosed_output_res, file = file.path(resultpath,"07_rsclosed_PCA_subtype*age.csv"))
```
