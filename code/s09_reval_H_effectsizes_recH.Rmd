...
```{r, warning=FALSE, message=FALSE}
# rsopen
dt_rseo_pc1 = read.csv(file.path(datapath,"tidy_H_rsopen_reconstructedHfromPC1.csv"))
dt_rseo_pc4 = read.csv(file.path(datapath,"tidy_H_rsopen_reconstructedHfromPC4.csv"))
dt_rseo_pc1pc4 = read.csv(file.path(datapath,"tidy_H_rsopen_reconstructedHfromPC1&4.csv"))

#rsclosed
dt_rsec_pc1 = read.csv(file.path(datapath,"tidy_H_rsclosed_reconstructedHfromPC1.csv"))
dt_rsec_pc4 = read.csv(file.path(datapath,"tidy_H_rsclosed_reconstructedHfromPC4.csv"))
```
...
write.csv(rseo_pc1_output, file = file.path(resultpath,"09_rsopen_Hrec-PC1_effectsizes.csv"))
```
...
write.csv(rseo_pc4_output, file = file.path(resultpath,"09_rsopen_Hrec-PC4_effectsizes.csv"))
```
...
write.csv(rseo_pc1pc4_output, file = file.path(resultpath,"09_rsopen_Hrec-PC1PC4_effectsizes.csv"))
```
...
write.csv(rsec_pc1_output, file = file.path(resultpath,"09_rsclosed_Hrec-PC1_effectsizes.csv"))
```
...
ggsave(filename = file.path(rsopen_plotpath,"d","09_d_Hrec-PC1_acrossblocks.pdf"))
...
ggsave(filename = file.path(rsopen_plotpath,"d","09_d_Hrec-PC4_acrossblocks.pdf"))
...
ggsave(filename = file.path(rsopen_plotpath,"d","09_d_Hrec-PC1PC4_acrossblocks.pdf"))
...
ggsave(filename = file.path(rsclosed_plotpath,"d","09_d_Hrec-PC1_acrossblocks.pdf"))
```
