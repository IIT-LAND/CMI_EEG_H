...
libraries("here","tidyverse","report","lmerTest","sigclust", "stringr")
...
```{r, warning=FALSE, message=FALSE}
tidy_data = read.csv(file.path(tidypath,"tidy_H_revalsubgroups_global.csv"))
```
...
rsopen_H_pheno = tidy_data %>%
  ...
  select(subid, dx, dx1_short, age, release_number, study_site, 
         ...
         brain_components, num_bad_channels, pct_bad_samples,
         Electrodes, block, H) %>% 
  distinct()
...
electrode_names = unique(rsopen_H_pheno$Electrodes)
...
for (electrode in electrode_names){
  ...
  data4model = rsopen_H_pheno %>% filter(Electrodes == electrode) 

  # scale data
  vars2scale = c("H","age", "num_bad_channels", "pct_bad_samples")
  ...
  form2use = as.formula("H ~ subtype*age + num_bad_channels + pct_bad_samples + (1|study_site) + (block|subid)")
  ...
  # save output 
  rsopen_output_res[electrode,"Electrode"] = electrode
  
  rsopen_output_res[electrode,"subtype_F"] = aov_res["subtype","F value"]  
  rsopen_output_res[electrode,"subtype_p"] = aov_res["subtype","Pr(>F)"] 
  
  rsopen_output_res[electrode,"age_F"] = aov_res["age","F value"]  
  rsopen_output_res[electrode,"age_p"] = aov_res["age","Pr(>F)"]
  
  rsopen_output_res[electrode,"subtypeXage_F"] = aov_res["subtype:age","F value"]
  rsopen_output_res[electrode,"subtypeXage_p"] = aov_res["subtype:age","Pr(>F)"]  
  
  rsopen_output_res[electrode,"td_vs_a1_t"] = lme_res$coefficients["subtypea1","t value"] 
  rsopen_output_res[electrode,"td_vs_a1_p"] = lme_res$coefficients["subtypea1","Pr(>|t|)"] 
  
  rsopen_output_res[electrode,"td_vs_a2_t"] = lme_res$coefficients["subtypea2","t value"] 
  rsopen_output_res[electrode,"td_vs_a2_p"] = lme_res$coefficients["subtypea2","Pr(>|t|)"]
  
  rsopen_output_res[electrode,"a1_vs_a2_b1_d"] = a1_v_a2_H_b1_d
  rsopen_output_res[electrode,"a1_vs_a2_b2_d"] = a1_v_a2_H_b2_d
  rsopen_output_res[electrode,"a1_vs_a2_b3_d"] = a1_v_a2_H_b3_d
  rsopen_output_res[electrode,"a1_vs_a2_b4_d"] = a1_v_a2_H_b4_d
  rsopen_output_res[electrode,"a1_vs_a2_b5_d"] = a1_v_a2_H_b5_d
  rsopen_output_res[electrode,"a1_vs_a2_mean_d"] = a1_v_a2_H_mean_d
  
  rsopen_output_res[electrode,"td_vs_a1_b1_d"] = td_v_a1_H_b1_d
  rsopen_output_res[electrode,"td_vs_a1_b2_d"] = td_v_a1_H_b2_d
  rsopen_output_res[electrode,"td_vs_a1_b3_d"] = td_v_a1_H_b3_d
  rsopen_output_res[electrode,"td_vs_a1_b4_d"] = td_v_a1_H_b4_d
  rsopen_output_res[electrode,"td_vs_a1_b5_d"] = td_v_a1_H_b5_d
  rsopen_output_res[electrode,"td_vs_a1_mean_d"] = td_v_a1_H_mean_d
  
  rsopen_output_res[electrode,"td_vs_a2_b1_d"] = td_v_a2_H_b1_d
  rsopen_output_res[electrode,"td_vs_a2_b2_d"] = td_v_a2_H_b2_d
  rsopen_output_res[electrode,"td_vs_a2_b3_d"] = td_v_a2_H_b3_d
  rsopen_output_res[electrode,"td_vs_a2_b4_d"] = td_v_a2_H_b4_d
  rsopen_output_res[electrode,"td_vs_a2_b5_d"] = td_v_a2_H_b5_d
  rsopen_output_res[electrode,"td_vs_a2_mean_d"] = td_v_a2_H_mean_d
  ...
  #   labs(x = "\nsubtype", y = "H\n", title = electrode, subtitle = "H values by subtype by block\n")  +
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsopen_plotpath,"H",sprintf("04_H_byblock_%s.pdf",electrode)))
  # 
  ...
  #   geom_boxplot(alpha = 0, width = .7, outlier.shape = NA) +
  #   scale_color_manual(values = colors4plots) + 
  #   labs(x = "\nsubtype", y = "H\n", title = electrode, subtitle = "H values by subtype\n")  +
  #   scale_x_discrete(labels=c('td', 'a1', 'a2')) +
  #   theme_bw() + 
  #   theme(plot.title = element_text(size = 12),
  #         plot.subtitle = element_text(size = 11),
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsopen_plotpath,"H",sprintf("04_H_blockscollapsed_%s.pdf",electrode)))
  # 
  ...
  #   scale_color_manual(values = colors4plots) + 
  #   labs(x = "\nage", y = "H\n", title = electrode, subtitle = "H values across age for each block\n")  +
  #   theme_bw() + 
  #   theme(plot.title = element_text(size = 12),
  #         plot.subtitle = element_text(size = 11),
  #         axis.title.x = element_text(size = 10), axis.title.y = element_text(size = 10),
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsopen_plotpath,"H",sprintf("04_H_age_%s.pdf",electrode)))
  # 
  ...
  #  scale_color_manual(values = colors4plots) + 
  #   labs(x = "\nage", y = "H\n", title = electrode, subtitle = "H values across age\n")  +
  #   theme_bw() + 
  #   theme(plot.title = element_text(size = 12),
  #         plot.subtitle = element_text(size = 11),
  #         axis.title.x = element_text(size = 10), axis.title.y = element_text(size = 10),
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsopen_plotpath,"H",sprintf("04_H_age2_%s.pdf",electrode)))
...
for (electrode in electrode_names){
  ...
  # prepare data for the modeling and plotting
  data4model = rsclosed_H_pheno %>% filter(Electrodes == electrode) 
  ...
  # save output 
  rsclosed_output_res[electrode,"Electrode"] = electrode
  
  rsclosed_output_res[electrode,"subtype_F"] = aov_res["subtype","F value"]  
  rsclosed_output_res[electrode,"subtype_p"] = aov_res["subtype","Pr(>F)"]  
  
  rsclosed_output_res[electrode,"age_F"] = aov_res["age","F value"]  
  rsclosed_output_res[electrode,"age_p"] = aov_res["age","Pr(>F)"] 
  
  rsclosed_output_res[electrode,"subtypeXage_F"] = aov_res["subtype:age","F value"]  
  rsclosed_output_res[electrode,"subtypeXage_p"] = aov_res["subtype:age","Pr(>F)"]
  
  rsclosed_output_res[electrode,"td_vs_a1_t"] = lme_res$coefficients["subtypea1","t value"] 
  rsclosed_output_res[electrode,"td_vs_a1_p"] = lme_res$coefficients["subtypea1","Pr(>|t|)"] 
  rsclosed_output_res[electrode,"td_vs_a2_t"] = lme_res$coefficients["subtypea2","t value"] 
  rsclosed_output_res[electrode,"td_vs_a2_p"] = lme_res$coefficients["subtypea2","Pr(>|t|)"]
  
  rsclosed_output_res[electrode,"a1_vs_a2_b1_d"] = a1_v_a2_H_b1_d
  rsclosed_output_res[electrode,"a1_vs_a2_b2_d"] = a1_v_a2_H_b2_d
  rsclosed_output_res[electrode,"a1_vs_a2_b3_d"] = a1_v_a2_H_b3_d
  rsclosed_output_res[electrode,"a1_vs_a2_b4_d"] = a1_v_a2_H_b4_d
  rsclosed_output_res[electrode,"a1_vs_a2_b5_d"] = a1_v_a2_H_b5_d
  rsclosed_output_res[electrode,"a1_vs_a2_mean_d"] = a1_v_a2_H_mean_d
  
  rsclosed_output_res[electrode,"td_vs_a1_b1_d"] = td_v_a1_H_b1_d
  rsclosed_output_res[electrode,"td_vs_a1_b2_d"] = td_v_a1_H_b2_d
  rsclosed_output_res[electrode,"td_vs_a1_b3_d"] = td_v_a1_H_b3_d
  rsclosed_output_res[electrode,"td_vs_a1_b4_d"] = td_v_a1_H_b4_d
  rsclosed_output_res[electrode,"td_vs_a1_b5_d"] = td_v_a1_H_b5_d
  rsclosed_output_res[electrode,"td_vs_a1_mean_d"] = td_v_a1_H_mean_d
  
  rsclosed_output_res[electrode,"td_vs_a2_b1_d"] = td_v_a2_H_b1_d
  rsclosed_output_res[electrode,"td_vs_a2_b2_d"] = td_v_a2_H_b2_d
  rsclosed_output_res[electrode,"td_vs_a2_b3_d"] = td_v_a2_H_b3_d
  rsclosed_output_res[electrode,"td_vs_a2_b4_d"] = td_v_a2_H_b4_d
  rsclosed_output_res[electrode,"td_vs_a2_b5_d"] = td_v_a2_H_b5_d
  rsclosed_output_res[electrode,"td_vs_a2_mean_d"] = td_v_a2_H_mean_d
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsclosed_plotpath,"H",sprintf("04_H_byblock_%s.pdf",electrode)))
  # 
  # # plot H for each electrode and across all blocks
  # p = ggplot(data = data4model, aes(x = subtype, y = H)) + 
  #   geom_jitter(aes(col = subtype), alpha = 0.15, size = 2 , width = .25) +
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsclosed_plotpath,"H",sprintf("04_H_blockscollapsed_%s.pdf",electrode)))
  # 
  # # plot against age across blocks
  # p = ggplot(data = data4model, aes(x = age, y = H, colour = subtype)) + facet_grid(block ~ .,  labeller = label_both) + 
  #   geom_point(alpha=0.1, size = 1.5) + geom_smooth(method = lm) +
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsclosed_plotpath,"H",sprintf("04_H_age_%s.pdf",electrode)))
  # 
  # # plot H against age and collapsing blocks
  # p = ggplot(data = data4model, aes(x = age, y = H, colour = subtype)) +
  #   geom_point(alpha = 0.1, size = 2) + geom_smooth(method = lm) +
  ...
  #         aspect.ratio = 0.3)
  # 
  # ggsave(filename = file.path(rsclosed_plotpath,"H",sprintf("04_H_age2_%s.pdf",electrode)))
...
write.csv(rsopen_output_res, file = file.path(resultpath,"04_rsopen_electrodes_subtype*age.csv"))
write.csv(rsclosed_output_res, file = file.path(resultpath,"04_rsclosed_electrodes_subtype*age.csv"))
```
...
ggsave(filename = file.path(rsopen_plotpath,"H", "04_H_age_allElectrodes_facetBlocks.png"))
...
ggsave(filename = file.path(rsclosed_plotpath,"H","04_H_age_allElectrodes_facetBlocks.png"))
```
