...
write.csv(output_res, file = file.path(resultpath, "11_rsopen_pheno_analyses.csv"))
```
...
rseo_age_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_age.pdf"))
...
rseo_fiq_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_fiq.pdf"))
...
rseo_srs_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_srs_total_T.pdf"))
...
rseo_rbs_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_rbs_total.pdf"))
...
rseo_scq_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_scq_total.pdf"))
...
rseo_assq_plot
ggsave(filename = file.path(rsopen_plotpath, "pheno", "11_assq_total.pdf"))
```
...
write.csv(output_res, file = file.path(resultpath, "11_rsclosed_pheno_analyses.csv"))
```
...
rseo_age_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_age.pdf"))
...
rseo_fiq_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_fiq.pdf"))
...
rseo_srs_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_srs_total_T.pdf"))
...
rseo_rbs_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_rbs_total.pdf"))
...
rseo_scq_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_scq_total.pdf"))
...
rseo_assq_plot
ggsave(filename = file.path(rsclosed_plotpath, "pheno", "11_assq_total.pdf"))
```
...
write.csv(all_pheno_summaries, file = file.path(resultpath, "restingstate_pheno_summary.csv"))
