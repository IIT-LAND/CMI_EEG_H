...
pdf(file = file.path(plotdir_rsopen,"pls", "rsopen_ALL_BSR_LV1_corr.pdf"), width = 7, height = 5)
...
pdf(file = file.path(plotdir_rsclosed,"pls", "rsclosed_ALL_BSR_LV1_corr.pdf"), width = 7, height = 5)
...
ggsave(filename = file.path(plotdir_rsopen,"pls", "rsopen_LV1.pdf"), width=5, height=5)
p
...
ggsave(filename = file.path(plotdir_rsopen,"pls", "rsopen_LV1_corr.pdf"), width=5, height=3.5)
dev.off()
```
...
ggsave(filename = file.path(plotdir_rsclosed,"pls", "rsclosed_LV1.pdf"), width=5,height=5)
p

pdf(file = file.path(plotdir_rsclosed,"pls", "rsclosed_LV1_corr.pdf"), width = 5, height = 3.5)
